...
namespace HR.LeaveManagment.API.Controllers
{
    ...
    public class LeaveRequestController : ControllerBase
    {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult<int>> Put(int id, [FromBody] UpdateLeaveRequestDto leaveRequest)
        {   
        ...
        public async Task<ActionResult<int>> ChangeApproval(int id, [FromBody] ChangeLeaveRequestApprovalDto changeLeaveRequestApprovalDto)
        {
            if (changeLeaveRequestApprovalDto == null)
            {
                return BadRequest("Approval data must not be null.");
            }
